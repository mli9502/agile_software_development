...
void SleepCommand::execute() {
    ...
    if(!_started) {
        // cout << endl << "start a new SleepCommand at time: " << currentTime << endl;
        _started = true;
        _startTime = currentTime;
        // Note that in here, we have to use shared_from_this() instead of shared_ptr<T>(this).
        // This is because shared_ptr<T>(this) will create a NEW control block.
        // And, this will later cause problem when one of these shared_ptr is destructed. 
