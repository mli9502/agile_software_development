...
int main(void) {
    ...
    // This SleepCommand is needed to set DelayedTyper::_stop to true to terminate all the DelayedTyper instances.
    DelayedTyper::_engine.addCommand(make_shared<SleepCommand>(5000, DelayedTyper::_engine, make_shared<StopCommand<DelayedTyper>>()));
